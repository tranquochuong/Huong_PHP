    ...
    <div class="main">
        <div class="content">
            <div class="section group">
                ...
                ?>
                <p>Tổng tiền bàn đã mua: <?php echo $total = $amount * 0.1 + $amount . ' ' . 'VNĐ' ?> </p>
                <p>Chúng tôi sẽ liên lạc sớm nhất có thể. Vui lòng check lại đơn hàng của bạn <a href="orderdetails.php">tại đây</a></p>
            </div>
        </div>
</form>
